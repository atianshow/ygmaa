...
install_serverstatus() {
    ...
    docker run -d --restart=always --name=serverstatus -v /root/serverstatus-config.json:/ServerStatus/server/config.json -v /root/serverstatus-monthtraffic:/usr/share/nginx/html/json -p 7777:80 -p 35601:35601 cppla/serverstatus:latest
    if [ $? -eq 0 ]; then
