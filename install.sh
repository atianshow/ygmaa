...
install_wordpress1() {
    ...
    docker run --restart always -e MYSQL_ROOT_PASSWORD="Aa1989..@@" -e MYSQL_DATABASE=wordpress1 -e MYSQL_USER=wordpress1 -e MYSQL_PASSWORD=password -v wordpress1_db:/var/lib/mysql mysql:5.7
...
install_wordpress2() {
    ...
    docker run --restart always -e MYSQL_ROOT_PASSWORD="Aa1989..@@" -e MYSQL_DATABASE=wordpress2 -e MYSQL_USER=wordpress2 -e MYSQL_PASSWORD=password -v wordpress2_db:/var/lib/mysql mysql:5.7
